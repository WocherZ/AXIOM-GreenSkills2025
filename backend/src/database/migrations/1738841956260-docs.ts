...
export class Docs1738841956260 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "documents" ("id" uuid NOT NULL, "title" character varying, "archived" boolean NOT NULL DEFAULT false, "is_favorite" boolean NOT NULL DEFAULT false, "workspace_id" uuid NOT NULL, "folder_id" uuid, "user_id" uuid NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "preview_id" uuid, "doc_generate_id" uuid NOT NULL, CONSTRAINT "REL_cd9893742ab1f193e40bb1143c" UNIQUE ("doc_generate_id"), CONSTRAINT "PK_ac51aa5181ee2036f5ca482857c" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
